...
<body class="flex overflow-x-hidden">
    ...
    <aside class="sidebar p-6 flex flex-col">
        ...
        <nav class="space-y-4">
            ...
            <a href="edit.php?id=<?= $id ?>" class="flex items-center gap-3 px-4 py-3 bg-purple-500 text-white rounded-xl text-sm font-bold shadow-lg shadow-purple-500/20 transition-all">
                <iconify-icon icon="solar:pen-new-square-bold" class="text-xl"></iconify-icon> Edit Product
            </a>
        </nav>
    </aside>
